...
# names for the index.  Assign the series to variable 'mpg'
mpg = pd.Series(student_mileage, students)
...
rt_distance = pd.Series(2 * distance)
...
distance.divide(mpg, fill_value = 0)
